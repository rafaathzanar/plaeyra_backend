...
public class SlotService {
    ...
    public List<Slot> getAvailableSlotsByCourt(Long courtId) {
        return slotRepository.findByCourt_CourtIdAndStatus(courtId, Slot.SlotStatus.AVAILABLE);
    }
    ...
    public List<Slot> getSlotsByCourtAndStatus(Long courtId, Slot.SlotStatus status) {
        return slotRepository.findByCourt_CourtIdAndStatus(courtId, status);
    }
    ...
    public List<Slot> getAvailableSlotsByDateTimeRange(Long courtId, LocalDate date, LocalTime startTime,
            LocalTime endTime) {
        return slotRepository.findAvailableSlotsByCourtAndDateTimeRange(courtId, date, Slot.SlotStatus.AVAILABLE,
                startTime, endTime);
    }
    ...
    public List<Slot> getSlotsByBooking(Long bookingId) {
        return slotRepository.findByBooking_BookingId(bookingId);
    }

    public long getAvailableSlotCount(Long courtId, LocalDate date) {
        return slotRepository.countByCourt_CourtIdAndDateAndStatus(courtId, date, Slot.SlotStatus.AVAILABLE);
    }
